...
>
	...
	<div class="privacy-content">
		...
		<p>
			...
			저장합니다. 북마크에 추가하지 않은 QR 입력은 저장하지 않습니다. 구슬 레이스는 설정을 바꿀
			때마다 참가자 이름과 맵·당첨 방식·인원/순번·소리 설정·직접 만든 맵을 저장하며 경기 결과는
			저장하지 않습니다. 사이트의 테마와 메뉴 고정 설정도 같은 방식으로 저장합니다. 입력 내용과
			설정을 다시 불러오기 위한 용도이며, 사이트 코드가 이 정보를 운영자 서버로 전송하지 않습니다.
		</p>
