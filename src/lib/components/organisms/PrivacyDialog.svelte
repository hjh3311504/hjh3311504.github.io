...
>
	...
	<div class="privacy-content">
		...
		<p>
			...
			저장 공간인 localStorage에 보관합니다. 사이트의 테마와 메뉴 고정 설정도 같은 방식으로
			저장합니다. 입력 내용과 설정을 다시 불러오기 위한 용도이며, 사이트 코드가 이 정보를 운영자
			서버로 전송하지 않습니다.
		</p>
		...
		<p>
			...
			브라우저로 자동으로 옮겨지지 않습니다. 저장 명단과 경기 기록은 각각의 삭제 기능으로 지울 수
			있습니다. 모든 정보를 지우려면 브라우저 설정에서 이 사이트의 저장 데이터를 삭제하세요. 현재
			참가자만 삭제해도 저장 명단과 과거 기록은 남습니다. 운영자는 브라우저에 저장된 데이터를
			조회하거나 복구할 수 없습니다.
		</p>
