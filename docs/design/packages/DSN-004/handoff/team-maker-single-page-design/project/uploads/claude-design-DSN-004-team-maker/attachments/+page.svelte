...
<div class="team-maker-page" bind:this={pageRoot}>
	<main class="app-shell">
				...
				<div class="rules-heading">
					...
					<div class="rule-actions">
						<button id="add-together-rule" class="rule-button together" type="button"
							>같은 팀 지정</button
						>
						<button id="add-apart-rule" class="rule-button apart" type="button">다른 팀 지정</button
						>
					</div>
				</div>
		...
		<section class="results-section" aria-labelledby="results-title">
			...
			<section id="history-card" class="history-card" aria-labelledby="today-history-title" hidden>
				<div class="section-heading">
					<div>
						<h2 id="today-history-title">오늘 기록</h2>
